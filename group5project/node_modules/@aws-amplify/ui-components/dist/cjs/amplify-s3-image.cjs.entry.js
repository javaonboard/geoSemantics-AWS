...
const storageHelpers = require('./storage-helpers-f3a07734.js');
...
const AmplifyS3Image = class {
    ...
    render() {
        return (index.h(index.Host, null, this.src && index.h("img", { src: this.src, onLoad: this.handleOnLoad, onError: this.handleOnError })));
    }
