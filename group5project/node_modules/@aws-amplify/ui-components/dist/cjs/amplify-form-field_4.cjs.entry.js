...
const AmplifyFormField = class {
    ...
    render() {
        return (index.h("div", { class: "form-field" }, this.label && (index.h("div", { class: "form-field-label" }, index.h("amplify-label", { htmlFor: this.fieldId }, this.label))), this.description && (index.h("div", { id: `${this.fieldId}-description`, class: "form-field-description", "data-test": "form-field-description" }, this.description)), index.h("div", null, index.h("slot", { name: "input" }, index.h("amplify-input", { fieldId: this.fieldId, description: this.description, type: this.type, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.name, value: this.value, inputProps: this.inputProps, disabled: this.disabled }))), this.hint && index.h("amplify-hint", { id: `${this.fieldId}-hint` }, this.hint)));
    }
};
