                ...
                h("div", { class: "sign-up-form-footer", slot: "amplify-form-section-footer" },
                    h("slot", { name: "footer" },
                        ...
                        h("slot", { name: "primary-footer-content" },
                            h("amplify-button", { type: "submit", "data-test": "sign-up-create-account-button" }, this.loading ? h("amplify-loading-spinner", null) : h("span", null, I18n.get(this.submitButtonText)))))))));
    }
