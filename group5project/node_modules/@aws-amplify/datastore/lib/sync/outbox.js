...
var MutationEventOutbox = /** @class */ (function () {
    ...
    MutationEventOutbox.prototype.enqueue = function (storage, mutationEvent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, storage.runExclusive(function (s) { return __awaiter(_this, void 0, void 0, function () {
    ...
    MutationEventOutbox.prototype.dequeue = function (storage, record) {
        return __awaiter(this, void 0, void 0, function () {
            var head;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.syncOutboxVersionsOnDequeue(storage, record, head)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    MutationEventOutbox.prototype.syncOutboxVersionsOnDequeue = function (storage, record, head) {
        return __awaiter(this, void 0, void 0, function () {
            var _version, _lastChangedAt, incomingData, _a, __version, __lastChangedAt, outgoingData, mutationEventModelDefinition, predicate, outdatedMutations, reconciledMutations;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _version = record._version, _lastChangedAt = record._lastChangedAt, incomingData = __rest(record, ["_version", "_lastChangedAt"]);
                        _a = JSON.parse(head.data), __version = _a._version, __lastChangedAt = _a._lastChangedAt, outgoingData = __rest(_a, ["_version", "_lastChangedAt"]);
                        if (head.operation !== utils_1.TransformerMutationType.UPDATE) {
                            return [2 /*return*/];
                        }
                        // Don't sync the version when the data in the response does not match the data
                        // in the request, i.e., when there's a handled conflict
                        if (!util_1.objectsEqual(incomingData, outgoingData)) {
                            return [2 /*return*/];
                        }
                        mutationEventModelDefinition = this.schema.namespaces[util_1.SYNC].models['MutationEvent'];
