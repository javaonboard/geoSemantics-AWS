...
export declare function getUpdateMutationInput<T extends PersistentModel>(original: T, updated: T): {
    [key: string]: any;
};
export declare function objectsEqual(objA: object, objB: object): boolean;
