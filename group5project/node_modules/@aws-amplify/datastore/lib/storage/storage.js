                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        result.forEach(function (r) {
                            var _a = __read(r, 3), savedElement = _a[0], opType = _a[1], fromDB = _a[2];
                            var updatedElement;
                            if (opType === types_1.OpType.UPDATE && fromDB) {
                                // For update mutations we only want to send fields with changes
                                // and the required internal fields
                                updatedElement = util_1.getUpdateMutationInput(fromDB, savedElement);
                            }
                            var element = updatedElement || savedElement;
...
var ExclusiveStorage = /** @class */ (function () {
    ...
    ExclusiveStorage.prototype.save = function (model, condition, mutator) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.runExclusive(function (storage) { return storage.save(model, condition, mutator); })];
            });
        });
    };
