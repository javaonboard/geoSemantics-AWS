...
function () {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            if (message === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["f"] || message === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_5__["g"]) {
              this.TOTPSetup = true;
              this.selectMessage = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SETUP_TOTP_REQUIRED); // 	TODO Add Toast = showToast: true,
            } else {
              logger.debug('Set Preferred MFA failed', error_1);
              this.selectMessage = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].UNABLE_TO_SETUP_MFA_AT_THIS_TIME); // 	TODO Add Toast = showToast: true,
            }
  ...
  class_1.prototype.contentBuilder = function () {
    ...
    return (// TODO: Add Toast messages
      Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-section", {
        submitButtonText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SELECT_MFA_TYPE_SUBMIT_BUTTON_TEXT),
        headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SELECT_MFA_TYPE_HEADER_TEXT),
        handleSubmit: function handleSubmit(event) {
          return _this.handleSubmit(event);
        },
        loading: this.loading
      }, SMS ? Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-radio-button", {
        key: "sms",
        name: "MFAType",
        value: "SMS",
        label: "SMS",
      ...
      }) : null, TOTP ? Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-radio-button", {
        key: "totp",
        name: "MFAType",
        value: "TOTP",
        label: "TOTP",
      ...
      }) : null, Optional ? Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-radio-button", {
        key: "noMFA",
        name: "MFAType",
        value: "NOMFA",
        label: "No MFA",
  ...
  class_1.prototype.render = function () {
    return Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, this.contentBuilder(), this.TOTPSetup ? Object(_index_3fb5c139_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-totp-setup", {
      user: this.authData
    }) : null);
  };
